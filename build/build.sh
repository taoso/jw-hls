...
FLEXPATH=/opt/flex-4.6

echo ""
echo "Compiling chromelessPlayer.swf"
echo ""

$FLEXPATH/bin/mxmlc ../src/ChromelessPlayer.as \
	-sp ../src \
	-o ../chromelessPlayer.swf \
	-use-network=false \
	-optimize=true \
	-incremental=false \
	-target-player="11.1" \
...
$FLEXPATH/bin/mxmlc ../src/com/longtailvideo/jwplayer/media/AdaptiveProvider.as \
	-sp ../src \
	-o ../adaptiveProvider.swf \
	-library-path+=../libs \
	-load-externs=../libs/jwplayer-5-classes.xml \
	-use-network=false \
	-optimize=true \
	-incremental=false \
	-target-player="11.1" \
